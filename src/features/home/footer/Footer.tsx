...
export default function Footer() {
  return (
    <footer className="group/footer relative bg-[#020617] text-gray-300 pt-20 sm:pt-24 lg:pt-28 pb-10 overflow-hidden transition-colors duration-1000">
      ...
      {/* 1. FULL FOOTER AMBIENT GLOW (Turns the entire background blue on hover, deepest in the center) */}
      <div
      ...
      {/* 3. Top horizontal shadow mask flap */}
      ...
      {/* 4. Deep Central Pyramid Beam Flare */}
