    ...
    return (
        <section className="relative overflow-hidden  pt-28 px-4">
            <div className="lg:w-[1200] xl:w-[1300] mx-auto text-[#2B2B2B]">
                ...
                {/* 1. TrackForce */}
                <div className="mb-10">
                    <h3 className="text-[38px] font-semibold  mb-4 text-[#0C4EDB]">1. TrackForce</h3>
                ...
                {/* 2. Time Doctor */}
                <div className="mb-10">
                    <h3 className="text-[38px] font-semibold  mb-4 text-[#0C4EDB]">2. Time Doctor</h3>
                    <p className=" text-base leading-relaxed mb-4">
                ...
                {/* 3. Teramind */}
                <div className="mb-10">
                    <h3 className="text-[38px] font-semibold mb-4 text-[#0C4EDB]">3. Teramind</h3>
