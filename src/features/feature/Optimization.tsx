                ...
                <div className="relative z-10">
                    ...
                    <div className="text-center mb-14">
                        <h2 className="text-4xl md:text-[42px] font-bold text-[#0a0a1a]">
                            Fortune 100 Company Optimizes  {" "}
                            <span className="font-playball font-normal">Hybrid</span>

                        </h2>
                        <h2 className="text-4xl md:text-[42px] font-bold text-[#0a0a1a] mt-2">Work</h2>
                        <div className=" flex items-center justify-center text-center">
                            <p className="w-[750] text-gray-600 text-sm md:text-base mt-3">
                                A Fortune 100 company tracks remote vs. in-office productivity by centralizing employee location and activity data in a single dashboard, revealing policy violations and performance issues while enabling data-driven decisions about their hybrid work model.
                            </p>
                        </div>
                    </div>
